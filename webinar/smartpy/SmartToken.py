...
class SmartToken(sp.Contract):
    ...
    def transfer(self, params):
        ...
        updateApprovals = (params.fromAddr != sp.sender) & (sp.sender != self.data.administrator)
        sp.if (updateApprovals):
            self.data.balances[params.fromAddr].approvals[params.toAddr] -= params.amount
...
if "templates" not in __name__:
    ...
    def test():
        ...
        scenario += c1.transfer(fromAddr = alice, toAddr = bob, amount=800).run(sender = admin)
